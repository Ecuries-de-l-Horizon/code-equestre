...
if(empty($_SESSION['mail'])){ 
    header('Location: http://localhost/tp_projet/admin/form_connexion.php');
}else{
?><html><head>
<meta charset="utf-8">
<title>Ma page</title>
...
<body>
    ...
    <nav>
        <a class="special" href="" title="Histoire"> <center>histoire de lentreprise</center> </a> 
        <a class="special" href="" title="Formulaire de contacte de lentreprise"> <center>Formulaire de contacte</center> </a>
        <a class="special" href="" title="Avis"> <center> Avis clients </center> </a>
        <a class="special" href="" title="Avis"> <center> Support clients </center> </a> 
        <div class="carre"></div>
    </nav>
    <br>
